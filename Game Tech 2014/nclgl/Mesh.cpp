...
Mesh*    Mesh::GenerateCube()
{
	...
	m->textureCoords[6] = Vector2(0.0f, 1.0f);
	m->textureCoords[7] = Vector2(0.0f, 0.0f);
	...
	m->textureCoords[10] = Vector2(1.0f, 0.0f);
	m->textureCoords[11] = Vector2(1.0f, 1.0f);

	m->vertices[12] = Vector3(-1.f, -1.f, -1.f);
	m->vertices[13] = Vector3(1.f, -1.f, -1.f);
	m->vertices[14] = Vector3(1.f, -1.f, 1.f);
	m->vertices[15] = Vector3(-1.f, -1.f, 1.f);

	m->textureCoords[12] = Vector2(1.0f, 1.0f);
	m->textureCoords[13] = Vector2(0.0f, 1.0f);
	m->textureCoords[14] = Vector2(0.0f, 0.0f);
	m->textureCoords[15] = Vector2(1.0f, 0.0f);

	m->vertices[16] = Vector3(1.f, -1.f, -1.f);
	m->vertices[17] = Vector3(1.f, 1.f, -1.f);
	m->vertices[18] = Vector3(1.f, 1.f, 1.f);
	m->vertices[19] = Vector3(1.f, -1.f, 1.f);

	m->textureCoords[16] = Vector2(1.0f, 0.0f);
	m->textureCoords[17] = Vector2(1.0f, 1.0f);
	m->textureCoords[18] = Vector2(0.0f, 1.0f);
	m->textureCoords[19] = Vector2(0.0f, 0.0f);

	m->vertices[20] = Vector3(-1.f, -1.f, -1.f);
	m->vertices[21] = Vector3(-1.f, -1.f, 1.f);
	m->vertices[22] = Vector3(-1.f, 1.f, 1.f);
	m->vertices[23] = Vector3(-1.f, 1.f, -1.f);

	m->textureCoords[20] = Vector2(0.0f, 0.0f);
	m->textureCoords[21] = Vector2(1.0f, 0.0f);
	m->textureCoords[22] = Vector2(1.0f, 1.0f);
	m->textureCoords[23] = Vector2(0.0f, 1.0f);
